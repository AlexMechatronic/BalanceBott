...
////////////////////////////////////////////////////////////////////
#elif defined MOTION_DRIVER_TARGET_RPI
#include <bcm2835.h>
#include <math.h>

//i2c_write(devAddr, regAddr, lenght, *data)
#define i2c_write   bcm2835_i2c_write(const char * buf, uint32_t len);
#define i2c_read    bcm2835_i2c_read(const char * buf, uint32_t len);
#define delay_ms    msp430_delay_ms
#define get_ms      msp430_get_clock_ms
//adaptar interrupcion por
static inline int reg_int_cb(struct int_param_s *int_param)
{
    return msp430_reg_int_cb(int_param->cb, int_param->pin, int_param->lp_exit,
        int_param->active_low);
